...
use crate::objc_helpers::{nsstring_from_str, nsstring_to_string, template_image_from_png};
...
const SETTINGS_PANE_HEIGHT: f64 = SETTINGS_TOP_MARGIN
...
unsafe fn make_pane_view(height: f64) -> *mut AnyObject {
    let rect = NSRect {
